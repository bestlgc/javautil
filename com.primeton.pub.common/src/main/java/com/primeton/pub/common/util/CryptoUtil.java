...
import com.primeton.pub.common.util.spi.Cipher;
import com.primeton.pub.common.util.spi.Digestor;
import com.primeton.pub.common.util.spi.Signaturer;
...
public class CryptoUtil {
	...
	public static String digest(String dataString, String algorithm) {
		...
		String result = null;
		try {
			result = new String(digestor.digest(dataString.getBytes(STR_ENCODE)), STR_ENCODE);
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
		}
		return result;
